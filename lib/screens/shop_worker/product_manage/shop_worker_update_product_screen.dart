...
class ShopWorkerUpdateProductScreen extends StatefulWidget
{
  ...
  ShopWorkerUpdateProductScreen(this.ownerId, this.shopId, this.productId, this.productName, this.buyingPrice, this.sellingPrice, this.barcodenumber, this.quantity, this.optionalField, this.optionalFieldValue, this.finalPrice, this.workerId);

  @override
  State<StatefulWidget> createState()
  {
    return ShopWorkerUpdateProductScreenState();
  }
}

class ShopWorkerUpdateProductScreenState extends State<ShopWorkerUpdateProductScreen>
{
