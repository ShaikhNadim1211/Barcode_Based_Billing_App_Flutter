import 'dart:io';
import 'package:barcode_based_billing_system/screens/shop_worker/scan_bill/shop_worker_scan_bill_customer_select_screen.dart';
...
class ShopWorkerBarcodeScanScreen extends StatefulWidget
{
  @override
  State<StatefulWidget> createState()
  {
    return ShopWorkerBarcodeScanScreenState();
  }
}

class ShopWorkerBarcodeScanScreenState extends State<ShopWorkerBarcodeScanScreen>
{
      ...
      child: Scaffold(
                ...
                builder: (context, snapshot) {
                  ...
                  else if (snapshot.hasData)
                  {
                    ...
                    var filteredProducts = products.where((product) {
                      ...
                      return scannedProducts.any((barcode) => barcode.displayValue == bNumber);
                    }).toList();
        ...
        floatingActionButton: permission ? FloatingActionButton(
            onPressed: () async {
              ...
              if(this.shopId.isNotEmpty && this.scannedProducts.isNotEmpty && this.productDetails.isNotEmpty)
              {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ShopWorkerScanBillCustomerSelectScreen(this.ownerId, this.shopId, this.scannedQuantity, this.productDetails, this.workerId)
                    )
                );
              }
              else
