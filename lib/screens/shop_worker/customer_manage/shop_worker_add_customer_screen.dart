...
class ShopWorkerAddCustomerScreen extends StatefulWidget
{
  final String ownerId;
  final String shopId;
  final String workerId;

  ShopWorkerAddCustomerScreen(this.ownerId, this.shopId, this.workerId);
  @override
  State<StatefulWidget> createState()
  {
    return ShopWorkerAddCustomerScreenState();
  }
}

class ShopWorkerAddCustomerScreenState extends State<ShopWorkerAddCustomerScreen>
{
