...
class ShopWorkerViewBillScreen extends StatefulWidget
{
  ...
  ShopWorkerViewBillScreen(this.ownerId, this.shopId, this.customerId, this.customerEmail, this.productDetail
  ...
  {
    return ShopWorkerViewBillScreenState();
  }
}

class ShopWorkerViewBillScreenState extends State<ShopWorkerViewBillScreen>
{
