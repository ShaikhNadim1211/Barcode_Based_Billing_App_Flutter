import 'package:barcode_based_billing_system/screens/shop_owner/customer_manage/shop_owner-view-customer-details_screen.dart';
import 'package:barcode_based_billing_system/screens/shop_owner/customer_manage/shop_owner_add_customer_screen.dart';
import 'package:barcode_based_billing_system/screens/shop_owner/customer_manage/shop_owner_update_customer_screen.dart';
...
class ShopOwnerManageCustomerScreen extends StatefulWidget
{
  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerManageCustomerScreenState();
  }
}

class ShopOwnerManageCustomerScreenState extends State<ShopOwnerManageCustomerScreen>
{
  ...
  {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String select = prefs.getString("customerSelectedShop") ?? "";
    String username = prefs.getString("username") ?? "";
                        ...
                        child: Container(
                          child: DropdownButton<String>(
                            ...
                            onChanged: (newShop) async {
                              ...
                              SharedPreferences prefs = await SharedPreferences.getInstance();
                              prefs.setString("customerSelectedShop", this.selectedShop);
                            },
                  ...
                  builder: (context, snapshot) {
                    ...
                    else if (snapshot.hasData)
                    {
                      ...
                      var filteredCustomers = customers.where((customer) {
                        ...
                        String aBy = customer["addedby"];
                        String uBy = customer["updatedby"];
                        ...
                        || uBy.toLowerCase().contains(searchQuery.toLowerCase()));
                      }).toList();
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        showDialog(
                                          context: context,
                                          builder: (context) => ShopOwnerViewCustomerDetailsScreen(
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        Navigator.pushReplacement(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context)=>ShopOwnerUpdateCustomerScreen(ownerId, shopId, customerId, customerName, phoneNumber, email, address)
                                            )
                                        );
                                      },
                                    ),
          ...
          onPressed: () async {
            ...
            if(this.selectedShop.isNotEmpty)
            {
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ShopOwnerAddCustomerScreen(this.username, this.selectedShop)
                  )
              );
            }
            else
