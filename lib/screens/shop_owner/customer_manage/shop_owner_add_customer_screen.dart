...
class ShopOwnerAddCustomerScreen extends StatefulWidget
{
  final String ownerId;
  final String shopId;

  ShopOwnerAddCustomerScreen(this.ownerId, this.shopId);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerAddCustomerScreenState();
  }
}

class ShopOwnerAddCustomerScreenState extends State<ShopOwnerAddCustomerScreen>
{
