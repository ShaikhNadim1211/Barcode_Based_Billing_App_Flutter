...
class ShopOwnerUpdateCustomerScreen extends StatefulWidget
{
  ...
  ShopOwnerUpdateCustomerScreen(this.ownerId, this.shopId, this.customerId, this.customerName, this.phoneNumber, this.email, this.address);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerUpdateCustomerScreenState();
  }
}

class ShopOwnerUpdateCustomerScreenState extends State<ShopOwnerUpdateCustomerScreen>
{
