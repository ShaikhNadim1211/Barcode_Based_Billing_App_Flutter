...
class ShopOwnerViewProductDetailsScreen extends StatefulWidget
{
  ...
  ShopOwnerViewProductDetailsScreen(this.ownerId, this.shopId, this.productId, this.productName, this.buyingPrice, this.sellingPrice, this.barcodenumber, this.quantity, this.optionalField, this.optionalFieldValue, this.finalPrice, this.addedBy, this.updatedBy);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerViewProductDetailsScreenState();
  }
}

class ShopOwnerViewProductDetailsScreenState extends State<ShopOwnerViewProductDetailsScreen>
{
  ...
  void initState()
  {
    ...
    this.addedBy = widget.addedBy;
    this.updatedBy = widget.updatedBy;
  }
