...
class ShopOwnerAddProductScreen extends StatefulWidget
{
  final String username;
  final String shopName;

  ShopOwnerAddProductScreen(this.username, this.shopName);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerAddProductScreenState();
  }
}

class ShopOwnerAddProductScreenState extends State<ShopOwnerAddProductScreen>
{
  ...
  {
    super.initState();
    this.username = widget.username.toString();
    this.shopName = widget.shopName;
  }
  @override
