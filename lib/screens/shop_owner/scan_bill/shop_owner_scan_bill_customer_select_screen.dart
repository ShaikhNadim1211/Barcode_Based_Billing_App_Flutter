...
import 'package:barcode_based_billing_system/screens/shop_owner/scan_bill/shop_owner_scan_bill_checkout_screen.dart';
import 'package:barcode_based_billing_system/screens/shop_owner/scan_bill/shop_owner_scan_bill_customer_add_screen.dart';
...
class ShopOwnerScanBillCustomerSelectScreen extends StatefulWidget
{
  ...
  ShopOwnerScanBillCustomerSelectScreen(this.ownerId, this.shopId, this.barcodeNumberAndQuantity, this.productDetails);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerScanBillCustomerSelectScreenState();
  }
}

class ShopOwnerScanBillCustomerSelectScreenState extends State<ShopOwnerScanBillCustomerSelectScreen>
{
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: (){
                                      ...
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => ShopOwnerScanBillCheckoutScreen(widget.ownerId, widget.shopId, widget.barcodeNumberAndQuantity, widget.productDetails, customerId, email)
                                          )
                                      );
                                    },
                                  ),
          ...
          onPressed: () async {
            ...
            if(this.ownerId.isNotEmpty && this.shopId.isNotEmpty)
            {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ShopOwnerScanBillCustomerAddScreen(this.ownerId, this.shopId)
                  ),
              );
            }
            else
