...
import 'package:barcode_based_billing_system/screens/shop_owner/scan_bill/shop_owner_scan_bill_preview_screen.dart';
...
class ShopOwnerScanBillCheckoutScreen extends StatefulWidget
{
  ...
  ShopOwnerScanBillCheckoutScreen(this.ownerId, this.shopId, this.barcodeNumberAndQuantity, this.productDetails,this.customerId, this.customerEmail);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerScanBillCheckoutScreenState();
  }
}

class ShopOwnerScanBillCheckoutScreenState extends State<ShopOwnerScanBillCheckoutScreen>
{
                    ...
                    if(this.extraChargesVerification && this.extraDiscountVerification)
                    {
                      ...
                      else
                      {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ShopOwnerScanBillPreviewScreen(widget.ownerId, widget.shopId, widget.barcodeNumberAndQuantity, widget.productDetails, widget.customerId, widget.customerEmail, extraCharges, extraDiscount, paymentType)
                            )
                        );
                      }
                    }
