...
class ShopOwnerScanBillCustomerAddScreen extends StatefulWidget
{
  final String ownerId;
  final String shopId;

  ShopOwnerScanBillCustomerAddScreen(this.ownerId, this.shopId);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerScanBillCustomerAddScreenState();
  }
}

class ShopOwnerScanBillCustomerAddScreenState extends State<ShopOwnerScanBillCustomerAddScreen>
{
