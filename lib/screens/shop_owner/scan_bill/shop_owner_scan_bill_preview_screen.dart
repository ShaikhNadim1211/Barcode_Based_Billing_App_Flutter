...
class ShopOwnerScanBillPreviewScreen extends StatefulWidget
{
  ...
  ShopOwnerScanBillPreviewScreen(this.ownerId, this.shopId, this.barcodeNumberAndQuantity, this.productDetails, this.customerId, this.customerEmail, this.extraCharges, this.extraDiscount, this.paymentType);

  @override
  State<StatefulWidget> createState()
  {
    return ShopOwnerScanBillPreviewScreenState();
  }
}

class ShopOwnerScanBillPreviewScreenState extends State<ShopOwnerScanBillPreviewScreen>
{
